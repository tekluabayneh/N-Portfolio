...
export function TelegramIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M23.91 3.79 20.3 20.84c-.25 1.21-.98 1.5-1.99.94l-5.5-4.07-2.66 2.57c-.3.3-.55.56-1.1.56l.38-5.56 10.1-9.13c.44-.39-.1-.61-.68-.22L6.27 13.5.65 11.74c-1.22-.38-1.24-1.22.26-1.81l21.26-8.2c1.02-.37 1.91.25 1.53 2.05Z" />
    </svg>
  )
}
